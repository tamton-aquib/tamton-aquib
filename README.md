...
|---|---|---|---|
| 602 | 7 | [duck.nvim](https://github.com/tamton-aquib/duck.nvim) | A duck that waddles arbitrarily in neovim. |
| 344 | 15 | [staline.nvim](https://github.com/tamton-aquib/staline.nvim) | A modern lightweight statusline and bufferline plugin for neovim in lua. |
| 243 | 7 | [zone.nvim](https://github.com/tamton-aquib/zone.nvim) | Screensaver plugin for neovim. |
| 101 | 2 | [flirt.nvim](https://github.com/tamton-aquib/flirt.nvim) | A neovim plugin to work with floating windows. |
| 92 | 1 | [stuff.nvim](https://github.com/tamton-aquib/stuff.nvim) | Some semi-util useless plugins put together |
| 90 | 1 | [keys.nvim](https://github.com/tamton-aquib/keys.nvim) | A screen keys plugin for neovim. |
| 59 | 1 | [nvim](https://github.com/tamton-aquib/nvim) | Personal neovim config |
| 46 | 3 | [mpv.nvim](https://github.com/tamton-aquib/mpv.nvim) | Music player with mpv. |
...
| 19 | 2 | [dotfiles](https://github.com/tamton-aquib/dotfiles) | My personal config files copied from all over the internet. |
| 19 | 5 | [ttt](https://github.com/tamton-aquib/ttt) | Typing test made with tkinter (python). |
...
| 16 | 0 | [nvim-market](https://github.com/tamton-aquib/nvim-market) | An extension market plugin for neovim |
